...
public class Zárthelyi implements Comparable<Zárthelyi> {
    ...
    public Zárthelyi(String neve, int mennyi) {
        this.neve = neve;
        this.mennyi = mennyi;
    }
    ...
    public String toString() {
        ...
        sb.append(this.neve).append(": ").append(this.mennyi).append(" pont");
        return sb.toString();
    }
...
class Test {
    ...
    public static void main(String[] args) {
        ...
        String sor = null;
        List<Zárthelyi> li = new ArrayList<>();
        ...
        for (String s : seged_map.keySet()) {
            li.add(new Zárthelyi(s, seged_map.get(s)));
        }
